...
obs_stage::~obs_stage() //Destructor, elimino todo lo que se cargó en el constructor para liberar la memoria.
{
...
void obs_stage::drawWorm(float x_, float y_, vector<ALLEGRO_BITMAP*>& sprite, int tick, int flag) //Dibujo al worm en su posición y sentido correspondiente.
{
